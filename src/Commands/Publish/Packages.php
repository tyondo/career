...
class Packages extends BaseCommand
{
     ...
     * @var string
     */
    protected $signature = 'career:publish:packages {--y|y : Skip question?} {--f|force : Overwrite existing files.}';
     ...
     * @var string
     */
    protected $description = 'Publish Tyondo career extra packages config files';
    ...
    public function handle()
    {
        ...
        if (! $publish) {
            $publish = $this->confirm('Publish career extra package config files?');
        }
